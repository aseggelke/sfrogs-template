<template>
  <div>
  <div>
    <LazyLoad file-mobile="datenschutz2.jpg" file="datenschutz.jpg" low-res-file="datenschutz_lowres.jpg"
              low-res-file-mobile="datenschutz2_lowres.jpg">
      <div>
  ...
  <div class="py-12 px-7 md:px-16 padding">
    ...
    <div class="pb-8">
      ...
      <p>Weitere Informationen entnehmen Sie der Datenschutzerkl&auml;rung von Strato: <a class="underline"
                                                                                          ...
                                                                                          target="_blank"
                                                                                          rel="noopener noreferrer">https://www.strato.de/datenschutz/</a>.
      </p>
    ...
    <div class="flex md:block flex-col">
      <NuxtLink class="p-3 md:mr-5 mb-5 text-center hover:bg-black hover:text-white border-4 border-solid border-black"
                to="/">Zurück Zur
        Startseite
      </NuxtLink>
