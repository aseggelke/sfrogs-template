<template>
  <div>
    <div class="h-screen relative image">
      <div>
        <h1 class="text-center pt-14 lg:pt-10 text-white">Datenschutz</h1>
      </div>
    ...
    <div class="py-12 px-7 md:px-16 padding">
      <div class="pb-8">
        ...
        <p>Sie haben jederzeit das Recht, unentgeltlich Auskunft &uuml;ber Herkunft, Empf&auml;nger und Zweck Ihrer
          ...
          Umst&auml;nden die Einschr&auml;nkung der Verarbeitung Ihrer personenbezogenen Daten zu verlangen. Des
          Weiteren
      ...
      <div class="pb-8">
        <h2>2. Hosting</h2>
        <h3>Strato</h3>
        <p>Wir hosten unsere Website bei Strato. Anbieter ist die Strato AG, Pascalstra&szlig;e 10, 10587 Berlin
          (nachfolgend: &bdquo;Strato&ldquo;). Wenn Sie unsere Website besuchen, erfasst Strato verschiedene Logfiles
          inklusive Ihrer IP-Adressen.</p>
        <p>Weitere Informationen entnehmen Sie der Datenschutzerkl&auml;rung von Strato: <a class="underline"
        ...
        <p>Wir haben einen Vertrag &uuml;ber Auftragsverarbeitung (AVV) mit dem oben genannten Anbieter geschlossen.
      ...
      <div class="pb-8">
        ...
        <ul class="list-inside list-disc	">
          <li>Wenn Sie die Richtigkeit Ihrer bei uns gespeicherten personenbezogenen Daten bestreiten, ben&ouml;tigen wir in der Regel Zeit, um dies zu &uuml;berpr&uuml;fen. F&uuml;r die Dauer der Pr&uuml;fung haben Sie das Recht,
      ...
      <div class="flex md:block flex-col">
        <NuxtLink class="p-3 md:mr-5 mb-5 text-center hover:bg-black hover:text-white border-4 border-solid border-black" to="/">Zurück Zur
          Startseite
        </NuxtLink>
        <NuxtLink class="p-3 hover:bg-black text-center hover:text-white border-4 border-solid border-black" to="/Impressum">
          Impressum
        </NuxtLink>
      </div>
    </div>
...
.image {
  background: url('../assets/images/datenschutz2.jpg');
...
@media only screen and (min-width: 1024px) {
  .image {
    background: url('../assets/images/datenschutz.jpg');
    background-size: cover;
  }
  h3 {
